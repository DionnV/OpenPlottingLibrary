...
{
    public class ZGridRenderer : IRenderable
    {
        ...
        string fragmentShaderSource = @"
            ...
            void main(void)
            {
              ...
              out_frag_color = vec4( 1.0, 0.0, 0.0, 0.0 );
            }";
        ...
        public ZGridRenderer(List<Point3D> points)
            : this(points, 10)
        {

        }

        public ZGridRenderer(List<Point3D> points, int size)
        {
